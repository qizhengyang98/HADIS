...
def getargs():
    ...
    parser.add_argument('--profile-driven', action='store_true', dest='profileDriven',
                        default=False,
                        help=('Run the profile-driven experiment: simulated execution with '
                              '10x scaled latencies. Must match every other component.'))
    parser.add_argument('--do_simulate', action='store_true', default=False,
                        help='Simulate model execution without implying profile-driven mode')
